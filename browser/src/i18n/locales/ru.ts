const ru = {
  translation: {
    ...
    screenshot: {
      button: 'Снимок экрана',
      success: 'Снимок экрана сохранен в папку Загрузки',
      failed: 'Ошибка захвата снимка экрана',
      error: 'Произошла ошибка при захвате снимка экрана'
    },
    keyboard: {
